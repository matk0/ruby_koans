...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Returns the argument you passed in the inject method, after it applies the operation specified in the block, to each element of the array, using the argument.
  end
  ...
  def test_all_iteration_methods_work_on_any_collection_not_just_arrays
    ...
    upcased_hello = "hello".split.map { |letter| letter.upcase }
    assert_equal ["HELLO"], upcased_hello
  ...
  #   # code to read 'file'
  # ANSWER: I don't know exactly, but I guess the first one chops the file into lines and the second one opens it as a whole?
